...
restroom::restroom(QWidget* parent) : QWidget(parent)
{
	QLabel* label = new QLabel(this);
	label->setPixmap(QPixmap("./locations/houses/startHouse/restroom.jpg"));
...
void restroom::resizeEvent(QResizeEvent* event)
{
